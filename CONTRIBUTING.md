...
Thank you for your interest in contributing to ControlLoom! We welcome all contributions and are grateful for your help. This guide outlines how to get started with contributing to this project.
...
- **Repository**: [https://github.com/murillo-consulting/ControlLoom/](https://github.com/murillo-consulting/ControlLoom/)
- **npm package**: [https://www.npmjs.com/package/controlloom](https://www.npmjs.com/package/controlloom)
- **Required Node version**: `>=22.0.0`

### Setup

1. Fork the repository.
2. Clone your fork locally: `git clone https://github.com/your-username/controlloom.git`.
...
5. **Create a Pull Request**: Open a pull request against the `main` branch of the ControlLoom repository. Please make sure that your PR passes all CI checks.
...
2. Run `npx controlloom` to use the local version of ControlLoom from the root of the repository.

:::tip
Make sure to re-run `pnpm run build` after you modify any of the controlloom source files.
:::
