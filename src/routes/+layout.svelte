				...
				<div class="flex justify-between items-center h-16">
					...
					<div class="flex items-center">
						<a href="/" class="flex items-center space-x-3 hover:opacity-80 transition-opacity">
							<img src="/controlloom.svg" class="h-8 w-8" alt="ControlLoom logo" />
							<div class="flex flex-col">
								<span class="text-xl font-bold text-gray-900 dark:text-white"> ControlLoom </span>
								<span class="text-xs text-gray-500 dark:text-gray-400 -mt-1">
									Compliance evidence, versioned
								</span>
							</div>
						</a>
					</div>
					...
					<div class="flex items-center space-x-4">
						...
						<a
							...
							title="Github"
							href="https://github.com/murillo-consulting/ControlLoom"
							target="_blank"
						>
